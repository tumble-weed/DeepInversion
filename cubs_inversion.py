...
def run(args):
    ...
    if False:
        ...
        if True:
            net = torch.hub.load('nicolalandro/ntsnet-cub200', 'ntsnet', pretrained=True, **{'topN': 6, 'device':'cuda', 'num_classes': 200})
    ...
    from deepinversion_cubs import DeepInversionClass
